...
Route::middleware('auth')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/orders/{order}', [PageController::class, 'showOrder'])->name('orders.show');
    Route::get('/reports', [PageController::class, 'reports'])->name('reports.index');
    Route::get('/reports/detail', [PageController::class, 'showReportDetail'])->name('reports.show');
